 ...
 *
 * Date: Thu Aug 13 2015 11:32:10 GMT+0200 (CEST)
 */
/*jslint white: true, browser: true, plusplus: true, indent: 4, maxerr: 50 */

window.Handsontable = {
  version: '0.15.1',
  buildDate: 'Thu Aug 13 2015 11:32:10 GMT+0200 (CEST)'
};
...
($traceurRuntime.createClass)(NestedHeaders, {
  bindHooks: function() {
    ...
    this.hot.addHook('afterViewportColumnCalculatorOverride', (function(calc) {
      return $__2.onAfterViewportColumnCalculatorOverride(calc);
    }));
  },
  ...
  headerRendererFactory: function(headerRow) {
    ...
    return function(index, TH) {
      ...
      dom.removeClass(TH, 'hiddenHeader');
      ...
      dom.fastInnerHTML(spanEl, _this.colspanArray[headerRow][index] ? _this.colspanArray[headerRow][index].label || '' : '');
