 ...
 *
 * Date: Thu Aug 06 2015 12:35:56 GMT+0200 (CEST)
 */
/*jslint white: true, browser: true, plusplus: true, indent: 4, maxerr: 50 */

window.Handsontable = {
  version: '0.15.1',
  buildDate: 'Thu Aug 06 2015 12:35:56 GMT+0200 (CEST)'
};
...
($traceurRuntime.createClass)(NestedHeaders, {
  ...
  onAfterOnCellMouseOver: function(event, coords, TD) {
    if (coords.row < 0 && this.hot.view.isMouseDown()) {
      ...
      var fromCoords = this.hot.view.wt.selections[1].cellRange.from;
      var toCoords = this.hot.view.wt.selections[1].cellRange.to;
      var highlightCoords = this.hot.view.wt.selections[1].cellRange.highlight;
