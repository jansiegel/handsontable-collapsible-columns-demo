 ...
 *
 * Date: Thu Aug 06 2015 13:05:59 GMT+0200 (CEST)
 */
/*jslint white: true, browser: true, plusplus: true, indent: 4, maxerr: 50 */

window.Handsontable = {
  version: '0.15.1',
  buildDate: 'Thu Aug 06 2015 13:05:59 GMT+0200 (CEST)'
};
...
//# 
},{"./../plugins/jqueryHandsontable.js":1,"./cellTypes.js":24,"./core.js":25,"./pluginHooks.js":44,"./renderers/_cellDecorator.js":74,"./shims/array.filter.js":81,"./shims/array.indexOf.js":82,"./shims/array.isArray.js":83,"./shims/classes.js":84,"./shims/object.keys.js":85,"./shims/string.trim.js":86,"./shims/weakmap.js":87}],24:[function(require,module,exports){
"use strict";
...
//# 
},{"./editors.js":29,"./editors/autocompleteEditor.js":31,"./editors/checkboxEditor.js":32,"./editors/dateEditor.js":33,"./editors/dropdownEditor.js":34,"./editors/handsontableEditor.js":35,"./editors/mobileTextEditor.js":36,"./editors/numericEditor.js":37,"./editors/passwordEditor.js":38,"./editors/selectEditor.js":39,"./editors/textEditor.js":40,"./helpers.js":42,"./renderers.js":73,"./renderers/autocompleteRenderer.js":75,"./renderers/checkboxRenderer.js":76,"./renderers/htmlRenderer.js":77,"./renderers/numericRenderer.js":78,"./renderers/passwordRenderer.js":79,"./renderers/textRenderer.js":80,"./validators/autocompleteValidator.js":89,"./validators/dateValidator.js":90,"./validators/numericValidator.js":91}],25:[function(require,module,exports){
"use strict";
var $__dom_46_js__,
    $__helpers_46_js__,
    $__numeral__,
...
//# 
},{"./3rdparty/walkontable/src/cell/coords.js":5,"./3rdparty/walkontable/src/cell/range.js":6,"./3rdparty/walkontable/src/selection.js":18,"./dataMap.js":26,"./dom.js":27,"./editorManager.js":28,"./eventManager.js":41,"./helpers.js":42,"./plugins.js":45,"./renderers.js":73,"./tableView.js":88,"numeral":"numeral"}],26:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
...
var dom = ($___46__46__47__46__46__47_dom_46_js__ = require("./../../dom.js"), $___46__46__47__46__46__47_dom_46_js__ && $___46__46__47__46__46__47_dom_46_js__.__esModule && $___46__46__47__46__46__47_dom_46_js__ || {default: $___46__46__47__46__46__47_dom_46_js__});
var helpers = ($___46__46__47__46__46__47_helpers_46_js__ = require("./../../helpers.js"), $___46__46__47__46__46__47_helpers_46_js__ && $___46__46__47__46__46__47_helpers_46_js__.__esModule && $___46__46__47__46__46__47_helpers_46_js__ || {default: $___46__46__47__46__46__47_helpers_46_js__});
...
($traceurRuntime.createClass)(CollapsibleColumns, {
  ...
  bindHooks: function() {
    ...
    this.hot.addHook('beforeOnCellMouseDown', (function(event, coords, TD) {
      return $__3.onBeforeOnCellMouseDown(event, coords, TD);
    }));
  },
  ...
  generateIndicator: function(col, TH) {
    ...
    var row = (-1) * TH.parentNode.parentNode.childNodes.length + Array.prototype.indexOf.call(TH.parentNode.parentNode.childNodes, TH.parentNode);
  ...
  markSectionAs: function(state, row, col, TH, recursive) {
    ...
    if (recursive) {
      var nestedHeadersColspans = this.hot.getSettings().nestedHeaders.colspan;
      var reversedIndex = this.columnHeaderLevelCount + row;
      var childHeaders = this.getChildHeaders(row, col, nestedHeadersColspans[reversedIndex][col]);
      for (var i = 1,
          childrenLength = childHeaders.length; i < childrenLength; i++) {
        var nestedIndex = this.nestedHeadersPlugin.realColumnIndexToNestedIndex(row + 1, childHeaders[i]);
        if (nestedHeadersColspans[reversedIndex + 1] && nestedHeadersColspans[reversedIndex + 1][nestedIndex] > 1) {
          var nextTH = this.hot.view.wt.wtTable.THEAD.childNodes[reversedIndex + 1].childNodes[nestedIndex];
  ...
  toggleCollapsedSection: function(coords, TD, action) {
    var currentlyHiddenColumns = this.hiddenColumnsPlugin.settings;
    var TR = TD.parentNode;
    var THEAD = TR.parentNode;
    var headerLevel = THEAD.childNodes.length - Array.prototype.indexOf.call(THEAD.childNodes, TR) - 1;
    var colspanOffset = this.hot.getColspanOffset(coords.col, headerLevel);
    var headerColspan = parseInt(TD.getAttribute('colspan'), 10);
    ...
    var columnArray = helpers.deepClone(currentlyHiddenColumns);
    switch (action) {
      case 'collapse':
        var childHeaders = this.getChildHeaders(coords.row, coords.col, headerColspan);
        var firstElementColspan = 1;
        if (childHeaders[1]) {
          firstElementColspan = childHeaders[1] - childHeaders[0];
        }
        for (var i = firstElementColspan,
            colspan = headerColspan; i < colspan; i++) {
          var colToHide = coords.col + colspanOffset + i;
      ...
      case 'expand':
        for (var i$__5 = 1,
            colspan$__6 = headerColspan; i$__5 < colspan$__6; i$__5++) {
          var colToHide$__7 = coords.col + colspanOffset + i$__5;
          var foundIndex = columnArray.indexOf(colToHide$__7);
          if (foundIndex > -1) {
    ...
    var previousHiddenColumnsSetting = this.hot.getSettings().hiddenColumns;
  ...
  getChildHeaders: function(row, col, colspan) {
    var nestedPlugin = this.nestedHeadersPlugin;
    var colspanSettings = nestedPlugin.settings.colspan;
    var childColspanLevel = colspanSettings[this.columnHeaderLevelCount + row + 1];
    var realColumnIndex = nestedPlugin.nestedColumnIndexToRealIndex(row, col);
    var childNestedColumnIndex = nestedPlugin.realColumnIndexToNestedIndex(row + 1, realColumnIndex);
    var childHeaderRange = [];
    for (var i = childNestedColumnIndex; i < childNestedColumnIndex + colspan; i++) {
      if (childColspanLevel && childColspanLevel[i] > 1) {
        colspan -= childColspanLevel[i];
      }
      var realChildIndex = nestedPlugin.nestedColumnIndexToRealIndex(row + 1, i);
...
//# 
},{"./../../dom.js":27,"./../../eventManager.js":41,"./../../helpers.js":42,"./../../plugins.js":45,"./../_base.js":46}],50:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
  default: {get: function() {
      return $__default;
...
($traceurRuntime.createClass)(HiddenColumns, {
  ...
  bindHooks: function() {
    ...
    this.hot.addHook('afterGetColHeader', (function(col, TH) {
      return $__2.onAfterGetColHeader(col, TH);
    }));
    this.hot.addHook('afterUpdateSettings', (function() {
...
//# 
},{"./../../dom.js":27,"./../../plugins.js":45,"./../_base.js":46}],60:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
...
//# 
},{"./../../plugins.js":45}],61:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
...
//# 
},{"./../../dom.js":27,"./../../eventManager.js":41,"./../../helpers.js":42,"./../../plugins.js":45}],65:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
...
//# 
},{"./../../3rdparty/walkontable/src/cell/coords.js":5,"./../../3rdparty/walkontable/src/cell/range.js":6,"./../../3rdparty/walkontable/src/table.js":20,"./../../plugins.js":45}],66:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
  default: {get: function() {
      return $__default;
...
//# 
},{"./../../dom.js":27,"./../../eventManager.js":41,"./../../plugins.js":45,"./../_base.js":46}],67:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
...
var $___46__46__47__46__46__47_dom_46_js__,
    ...
    $___46__46__47__95_base_46_js__;
var dom = ($___46__46__47__46__46__47_dom_46_js__ = require("./../../dom.js"), $___46__46__47__46__46__47_dom_46_js__ && $___46__46__47__46__46__47_dom_46_js__.__esModule && $___46__46__47__46__46__47_dom_46_js__ || {default: $___46__46__47__46__46__47_dom_46_js__});
var $__0 = ($___46__46__47__46__46__47_plugins_46_js__ = require("./../../plugins.js"), $___46__46__47__46__46__47_plugins_46_js__ && $___46__46__47__46__46__47_plugins_46_js__.__esModule && $___46__46__47__46__46__47_plugins_46_js__ || {default: $___46__46__47__46__46__47_plugins_46_js__}),
    registerPlugin = $__0.registerPlugin,
    getPlugin = $__0.getPlugin;
var BasePlugin = ($___46__46__47__95_base_46_js__ = require("./../_base.js"), $___46__46__47__95_base_46_js__ && $___46__46__47__95_base_46_js__.__esModule && $___46__46__47__95_base_46_js__ || {default: $___46__46__47__95_base_46_js__}).default;
...
($traceurRuntime.createClass)(NestedHeaders, {
  bindHooks: function() {
    ...
    this.hot.addHook('afterGetColumnHeaderRenderers', (function(array) {
      return $__2.onAfterGetColumnHeaderRenderers(array);
    }));
    this.hot.addHook('afterInit', (function() {
      return $__2.onAfterInit();
    }));
    this.hot.addHook('afterOnCellMouseOver', (function(event, coords, TD) {
      return $__2.onAfterOnCellMouseOver(event, coords, TD);
    }));
  },
  onAfterOnCellMouseOver: function(event, coords, TD) {
    if (coords.row < 0 && this.hot.view.isMouseDown()) {
      var realColumnIndex = this.nestedColumnIndexToRealIndex(coords.row, coords.col);
      var currentColspan = parseInt(TD.getAttribute('colspan'), 10);
  ...
  prepareHeaderValue: function(value) {
    if (typeof value === 'function') {
      return value();
    } else {
      return value;
  ...
  headerRendererFactory: function(headerRow) {
    ...
    return function(index, TH) {
      var colspan = _this.settings.colspan && _this.settings.colspan[headerRow] ? _this.settings.colspan[headerRow][index] : 1;
      _this.columnHeaderLevelCount = _this.hot.view.wt.getSetting('columnHeaders').length;
      var realColumnIndex = _this.nestedColumnIndexToRealIndex(headerRow - _this.columnHeaderLevelCount, index);
      var overlays = _this.hot.view.wt.wtOverlays;
      var leftOverlayTable = overlays.leftOverlay ? overlays.leftOverlay.clone.wtTable.TABLE : null;
      var topLeftCornerOverlay = overlays.topLeftCornerOverlay ? overlays.topLeftCornerOverlay.clone.wtTable.TABLE : null;
      var isChildOfLeftOverlay = dom.isChildOf(TH, leftOverlayTable);
      var isChildOfTopLeftCornerOverlay = dom.isChildOf(TH, topLeftCornerOverlay);
      var fixedColumnsLeft = _this.hot.getSettings().fixedColumnsLeft;
      var isOnTheOverlappingOverlay = (colspan > 1 && realColumnIndex < fixedColumnsLeft && realColumnIndex + colspan >= fixedColumnsLeft && (isChildOfTopLeftCornerOverlay || isChildOfLeftOverlay));
      ...
      if (!(colspan > 1 && realColumnIndex < fixedColumnsLeft && realColumnIndex + colspan >= fixedColumnsLeft && (!isChildOfTopLeftCornerOverlay && !isChildOfLeftOverlay))) {
  ...
  onAfterGetColumnHeaderRenderers: function(array) {
    var overwriteHeaders = this.settings.overwriteHeaders;
    if (array) {
      if (overwriteHeaders === true) {
        array.length = 0;
      }
      for (var headersCount = this.settings.colHeaders.length,
          i = headersCount - (!overwriteHeaders ? array.length : 0) - 1; i >= 0; i--) {
  ...
  getColspan: function(row, col) {
    var currentLevel = this.settings.colspan[this.columnHeaderLevelCount + row] || [];
    return currentLevel[this.realColumnIndexToNestedIndex(row, col)] || 1;
  },
  realColumnIndexToNestedIndex: function(row, col) {
    var nestedHeadersColspans = this.settings.colspan;
    var colspanSum = 0;
    var i = 0;
    while (i < col) {
      var currentLevel = nestedHeadersColspans[this.columnHeaderLevelCount + row];
      var colspan = currentLevel ? currentLevel[i] : null;
      if (colspan > 1) {
  ...
  nestedColumnIndexToRealIndex: function(row, col) {
    var nestedHeadersColspans = this.settings.colspan || [];
    var colspanSum = 0;
    for (var i = 0; i < col; i++) {
      var currentLevel = nestedHeadersColspans[this.columnHeaderLevelCount + row];
...
//# 
},{"./../../dom.js":27,"./../../plugins.js":45,"./../_base.js":46}],68:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
...
//# 
},{"./../../plugins.js":45,"jsonpatch":"jsonpatch"}],69:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
...
//# 
},{"./../../plugins.js":45}],70:[function(require,module,exports){
"use strict";
var $___46__46__47__46__46__47_dom_46_js__,
...
//# 
},{"./../../dom.js":27,"./../../renderers.js":73}],71:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
...
//# 
},{"./../../dom.js":27,"./../../plugins.js":45,"./../_base.js":46}],72:[function(require,module,exports){
"use strict";
var $___46__46__47__46__46__47_helpers_46_js__;
var helper = ($___46__46__47__46__46__47_helpers_46_js__ = require("./../../helpers.js"), $___46__46__47__46__46__47_helpers_46_js__ && $___46__46__47__46__46__47_helpers_46_js__.__esModule && $___46__46__47__46__46__47_helpers_46_js__ || {default: $___46__46__47__46__46__47_helpers_46_js__});
...
//# 
},{"./../../helpers.js":42}],73:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
...
//# 
},{"./helpers.js":42}],74:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
...
//# 
},{"./../dom.js":27,"./../renderers.js":73}],75:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
...
//# 
},{"./../3rdparty/walkontable/src/cell/coords.js":5,"./../dom.js":27,"./../eventManager.js":41,"./../renderers.js":73}],76:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
...
//# 
},{"./../dom.js":27,"./../eventManager.js":41,"./../helpers.js":42,"./../renderers.js":73}],77:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
...
//# 
},{"./../dom.js":27,"./../renderers.js":73}],78:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
...
//# 
},{"./../dom.js":27,"./../helpers.js":42,"./../renderers.js":73,"numeral":"numeral"}],79:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
...
//# 
},{"./../dom.js":27,"./../renderers.js":73}],80:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
...
//# 
},{"./../dom.js":27,"./../helpers.js":42,"./../renderers.js":73}],81:[function(require,module,exports){
"use strict";
...
//# 
},{"./3rdparty/walkontable/src/cell/coords.js":5,"./3rdparty/walkontable/src/core.js":7,"./3rdparty/walkontable/src/selection.js":18,"./dom.js":27,"./eventManager.js":41,"./helpers.js":42}],89:[function(require,module,exports){
"use strict";
...
//# 
},{"./../editors.js":29,"moment":"moment"}],91:[function(require,module,exports){
"use strict";
...
},{}]},{},[23,47,48,49,67,59,50,68,51,52,53,54,55,56,57,58,60,61,62,63,64,65,66,69,70,71,72,89,90,91,75,76,77,78,79,80,31,35,32,33,40,34,36,37,38,39])("zeroclipboard")
});